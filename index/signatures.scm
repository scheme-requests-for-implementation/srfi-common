...
vector
  ...
  %-fold-right % fold-function seed ... => seed ...
  collection-fold-keys-left collection fold-function seed
  %-fold-keys-left % fold-function seed ... => seed ...
  collection-fold-keys-right collection fold-function
  %-fold-keys-right % fold-function seed ... => seed ...
...
map
  ...
  %? value => value
  *-size * => exact integer
  *-count * value=> exact integer
  *-get-any * [absence-thunk]=> value
  *-empty? * => boolean
  *->list * => list
  *-clear * => %
  *-clear! * => %
...
collection
  ordered-collection? value => value
  *-ordering-function * => procedure
  *-get-left * [absence-thunk]=> value
  *-get-right * [absence-thunk]=> value
  *-delete-left * => % value
  *-delete-left! * => % value
  *-delete-right * => % value
  *-delete-right! * => % value
...
limited-collection
  limited-collection? value => value

purely-mutable-collection
  purely-mutable-collection? value => value

collection
  directional-collection? value => value
  *-get-left * [absence-thunk]=> value
  *-get-right * [absence-thunk]=> value
  *-insert-left * value=> %
  *-insert-left! * value=> %
...
bag sequence flexible-sequence
  bag? value => value
  *-equivalence-function * => procedure
  ...
  *-add-from * source-bag => %
  *-add-from! * source-bag => %
  *-delete-from * source-bag => %
  *-delete-from! * source-bag => %
  *-delete-all-from * source-bag => %
  *-delete-all-from! * source-bag => %
...
sequence
  sequence? value => boolean
  *-ref * integer [absence-thunk] => value
  *-get-left * [absence-thunk]=> value
  *-get-right * [absence-thunk]=> value
  *-insert-right * value=> %
  *-insert-right! * value=> %
  ...
  *-add * value => %
  *-add! * value => %
  *-replace-from * dest-start source-sequence
  *-replace-from! * dest-start source-sequence
  *-copy * [start [end]] => %

flexible-sequence
  flexible-sequence? value => boolean
  *-insert * index value => %
  *-insert! * index value => %
  *-delete-at * index => %
  *-delete-at! * index => %
...
map
  ...
  % pair ... => %
  *-equivalence-function * => procedure
  *-key-equivalence-function * => procedure
  *-contains-key? * key => boolean
  *-keys->list * => list
  *-get * key [absence-thunk] => value
  *-put * key value [absence-thunk]=> % value
  *-put! * key value [absence-thunk]=> % value
  *-update * key func [absence-thunk] => %
  *-update! * key func [absence-thunk] => %
  *-delete * key => %
  *-delete! * key => %
  *-delete-from * bag => %
...
list
  make-list [size [default]] => list
  list value ... => list
  list-fold-left list fold-function seeds ... => seeds
  list-fold-right list fold-function seeds ... => seeds
  list-equivalence-function list => procedure
  list-copy list [start [end]] => list
  list->list list => list
  list? value => boolean
  list-size list => exact integer
  list-empty? list => boolean
  list-contains? list value => boolean
  list-ref list integer [absence-thunk] => value
  list-get-any list [absence-thunk] => value
  list-get-left list [absence-thunk] => value
  list-get-right list [absence-thunk] => value
  list-count list value => exact integer
  list= elt= lists ... => boolean
  list-add list value => list
  list-add! list value => list
  list-set list integer value => list
  list-set! list integer value => list
  list-insert-left list value => list
  list-insert-left! list value => list
  list-insert-right list value => list
  list-insert-right! list value => list
  list-delete list value => list
  list-delete! list value => list
  list-delete-left list => list value
  list-delete-left! list => list value
  list-delete-right list => list value
  list-delete-right! list => list value
  list-delete-all list value => list
  list-delete-all! list value => list
  list-add-from list bag => list
  list-add-from! list bag => list
  list-delete-from list bag => list
  list-delete-from! list bag => list
  list-delete-all-from list bag => list
  list-delete-all-from! list bag => list
  list-replace-from dest-start source-list [source-start
  list-replace-from! dest-start source-list [source-start
...
alist-map
  ...
  alist-map-size alist-map => exact integer
  alist-map-copy alist-map => alist-map
  alist-map->list alist-map => list
  alist-map-keys->list alist-map => list
  alist-map? value => boolean
  alist-map= elt= alist-maps ... => boolean
  alist-map-get alist-map key => value
  ...
  alist-map-delete! alist-map key => alist-map
  alist-map-delete-all alist-map key => alist-map
  alist-map-delete-all! alist-map key => alist-map
  alist-map-delete-from alist-map bag => alist-map
  alist-map-delete-from! alist-map bag => alist-map
  alist-map-delete-all-from alist-map bag => alist-map
  alist-map-delete-all-from! alist-map bag => alist-map
  alist-map-clear alist-map => alist-map
  alist-map-clear! alist-map => alist-map
...
vector
  ...
  vector-size vector => exact integer
  vector-empty? vector => boolean
  vector-contains? vector value => boolean
  vector-count vector value => exact integer
  vector-ref vector index [absence-thunk] => value
  vector-get-any vector [absence-thunk] => value
  vector-get-left vector [absence-thunk] => value
  vector-get-right vector [absence-thunk] => value
  vector-set vector index value => vector
  vector-set! vector index value => vector
  vector-replace-from dest-start source-vector
  vector-replace-from! dest-start source-vector
...
string
  ...
  string-size string => exact integer
  string-empty? string => boolean
  string? value => boolean
  string-contains? string character => boolean
  string-count string character => exact integer
  string-ref string index [absence-thunk] => value
  string-get-any string [absence-thunk] => value
  string-get-left string [absence-thunk] => value
  string-get-right string [absence-thunk] => value
  string-set string index character => string
  string-set! string index character => string
  string-replace-from dest-start source-string
  string-replace-from! dest-start source-string
  string= elt= strings ... => boolean
