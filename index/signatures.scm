...
((signature (make-specialized-array interval))
 ...
 (signature (make-specialized-array interval safe?))
...
((signature (array->specialized-array array))
 ...
 (signature (array->specialized-array array safe?))
...
((signature (list->specialized-array l interval))
 ...
 (signature (list->specialized-array l interval safe?))
...
((signature (array-copy array))
 ...
 (signature (array-copy array new-domain))
 (signature (array-copy array mutable?))
 (signature (array-copy array safe?))
 (signature (array-copy array result-storage-class new-domain))
 (signature (array-copy array result-storage-class mutable?))
 (signature (array-copy array result-storage-class safe?))
 (signature (array-copy array new-domain mutable?))
 (signature (array-copy array new-domain safe?))
 (signature (array-copy array mutable safe?))
 (signature (array-copy array result-storage-class new-domain mutable?))
 (signature (array-copy array result-storage-class new-domain safe?))
 (signature (array-copy array new-domain mutable? safe?))
 (signature (array-copy array result-storage-class mutable? safe?))
...
((signature (list->array domain))
 ...
 (signature (list->array domain mutable?))
 (signature (list->array domain safe?))
 (signature (list->array domain result-storage-class mutable?))
 (signature (list->array domain result-storage-class safe?))
 (signature (list->array domain mutable safe?))
